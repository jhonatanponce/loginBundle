...
use Test\LoginBundle\Entity\User;
use Test\LoginBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestLoginBundle:User')->findAll();
     ...
     * @Method("POST")
     * @Template("TestLoginBundle:User:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestLoginBundle:User:edit.html.twig")
     */
