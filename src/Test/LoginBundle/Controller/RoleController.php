...
use Test\LoginBundle\Entity\Role;
use Test\LoginBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestLoginBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("TestLoginBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestLoginBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestLoginBundle:Role:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ...
            ->setMethod('DELETE')
            ->add('submit', 'submit', array('label' => 'Eliminar','attr' => array('class' => 'btn btn-warning')))
            ->getForm()
        ;
    }
}
