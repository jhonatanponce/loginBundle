...
namespace Proxies\__CG__\Test\LoginBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Test\LoginBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Test\\LoginBundle\\Entity\\User' . "\0" . 'id', 'username', 'password', 'salt', 'user_roles');
        }
