...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_1' => 'getA2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e71Service',
            'a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_2' => 'getA2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e72Service',
            'a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_3' => 'getA2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e73Service',
            ...
            'cf56029422ff392da73a1553912f026ac29eb59eef50a2e7a0c4a56ff38d9746_1' => 'getCf56029422ff392da73a1553912f026ac29eb59eef50a2e7a0c4a56ff38d97461Service',
    ...
    /**
     * Gets the 'a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_1' service.
     *
     ...
     */
    protected function getA2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e71Service()
    {
        return $this->services['a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e72Service()
    {
        return $this->services['a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e73Service()
    {
        return $this->services['a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'K:/xampp/htdocs/loginBundle/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('K:/xampp/htdocs/loginBundle/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'K:/xampp/htdocs/loginBundle/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'K:/xampp/htdocs/loginBundle/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'cf56029422ff392da73a1553912f026ac29eb59eef50a2e7a0c4a56ff38d9746_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getCf56029422ff392da73a1553912f026ac29eb59eef50a2e7a0c4a56ff38d97461Service()
    {
        return $this->services['cf56029422ff392da73a1553912f026ac29eb59eef50a2e7a0c4a56ff38d9746_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'loginbundle', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_dfe923d259dd3cd9f60775d904b847c2f9db4bbf2cd7bdbe6bd5c3b6cc415eea');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_dfe923d259dd3cd9f60775d904b847c2f9db4bbf2cd7bdbe6bd5c3b6cc415eea');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_dfe923d259dd3cd9f60775d904b847c2f9db4bbf2cd7bdbe6bd5c3b6cc415eea');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'K:\\xampp\\htdocs\\loginBundle\\src\\Test\\LoginBundle\\Entity')), 'Test\\LoginBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TestLoginBundle' => 'Test\\LoginBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('K:/xampp/htdocs/loginBundle/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'K:/xampp/htdocs/loginBundle/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('cf56029422ff392da73a1553912f026ac29eb59eef50a2e7a0c4a56ff38d9746_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('K:/xampp/htdocs/loginBundle/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:K:/xampp/htdocs/loginBundle/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'K:/xampp/htdocs/loginBundle/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'K:/xampp/htdocs/loginBundle/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Test\\LoginBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($i, array('login_path' => '/admin/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $j->setProviderKey('secured_area');

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.user_db')), 'secured_area', $a, $c), 2 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/admin/logout')), 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'secured_area', $j, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $i, array('login_path' => '/admin/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/admin/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, '/admin/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('K:/xampp/htdocs/loginBundle/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('K:/xampp/htdocs/loginBundle/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('K:/xampp/htdocs/loginBundle/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_1'), 1 => $this->get('a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_2'), 2 => $this->get('a2589e36d813cf1fd1a55efe3704994629505ba144ec13249995883301bbf9e7_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'K:/xampp/htdocs/loginBundle/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'K:/xampp/htdocs/loginBundle/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\src\\Test\\LoginBundle/Resources/views', 'TestLogin');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('K:/xampp/htdocs/loginBundle/app/Resources/views');
        $instance->addPath('K:\\xampp\\htdocs\\loginBundle\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'K:\\xampp\\htdocs\\loginBundle\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'K:/xampp/htdocs/loginBundle/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('K:/xampp/htdocs/loginBundle/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Test\\LoginBundle\\Entity\\User', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'K:/xampp/htdocs/loginBundle/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'K:/xampp/htdocs/loginBundle/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'K:/xampp/htdocs/loginBundle/app/cache/dev',
            'kernel.logs_dir' => 'K:/xampp/htdocs/loginBundle/app/logs',
            'kernel.bundles' => array(
                ...
                'TestLoginBundle' => 'Test\\LoginBundle\\TestLoginBundle',
            ...
            'debug.container.dump' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:K:/xampp/htdocs/loginBundle/app/cache/dev/profiler',
            ...
            'router.resource' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'K:/xampp/htdocs/loginBundle/app/../web',
            'assetic.write_to' => 'K:/xampp/htdocs/loginBundle/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'K:/xampp/htdocs/loginBundle/app/cache/dev/doctrine/orm/Proxies',
