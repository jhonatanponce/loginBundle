        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/log')) {
                ...
                if ($pathinfo === '/admin/logout') {
                    return array (  '_controller' => 'Test\\LoginBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'logout',);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/user')) {
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_show')), array (  '_controller' => 'Test\\LoginBundle\\Controller\\UserController::showAction',));
                }
                not_admin_user_show:
